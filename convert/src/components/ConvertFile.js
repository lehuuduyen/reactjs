	...
	return <Row gutter={20}>
		...
		<Col xs={24} md={17} lg={19}>
			<Card className="convert convert__box">
				<Row>
					<Col sm={14}><Title>Chuyển đổi <b>{params[0]}</b> sang <b>{params[1]}</b></Title></Col>
					{fileList.length > 1 && <Col sm={10}>
				...
				<Upload.Dragger
					...
					itemRender={(originNode, file, fileList, {preview, remove}) => {
						...
						return <ItemUpload file={file} percent={percent} onRemove={(file) => remove()}/>
					}}
				>
					<div>
